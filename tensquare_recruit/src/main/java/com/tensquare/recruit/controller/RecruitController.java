...
public class RecruitController {
  ...
  public Result recommend() {
    List<Recruit> list = recruitService.findTop6ByStateOrderByCreatetime("2");
	...
	public Result newlist(){
		return new Result(true,StatusCode.OK,"查询成功",recruitService.findTop6ByStateOrderByCreatetime("0"));
	}
  ...
  public Result findSearch(
    ...
    return new Result(
        ...
        StatusCode.OK,
        "查询成功",
        new PageResult<Recruit>(pageList.getTotalElements(), pageList.getContent()));
  }
